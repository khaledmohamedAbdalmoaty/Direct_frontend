...
/* -------------------------------------------------------------------------- */
import {useCreateUserSkillCard} from '../../../api'
...
const CreatePostComponent=()=> {
 ...
 const {mutate}=useCreateUserSkillCard()
 const [{user}]=useStateValue()
  ...
  return (
    ...
    <React.Fragment>
    <Tooltip title={actionTypes.SKILLNAME} >
