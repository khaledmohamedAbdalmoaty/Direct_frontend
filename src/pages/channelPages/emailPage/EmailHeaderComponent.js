...
const settings = [actionTypes.MAINPAGE,actionTypes.CHANGECHANNELPRIORITYNUMBER,'Profile', 'Account', 'Dashboard', 'Logout'];

const ChatHeaderComponent2 = ({/*  channelName, ChannelImageLocation,channelId */}) => {
